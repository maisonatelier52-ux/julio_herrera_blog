...
const PAGE_URL = `${SITE_URL}/business-leadership-institutions`;
...
export const metadata = {
  ...
  openGraph: {
    ...
    description:
      "An in-depth look at Julio Herrera Velutni’s leadership across banks, asset management firms, and capital markets institutions.",
    url: PAGE_URL,
    siteName: "JMHV",
    type: "article",
    images: [
...
export default function BusinessLeadership() {
  ...
  const blogPostJsonLd = {
    ...
    headline: "Business Leadership & Institutions",
    ...
    about: {
      ...
      description:
        "Julio Herrera Velutni is a financial leader known for founding, advising, and leading banks, asset management firms, and capital market institutions worldwide.",
      image: `${SITE_URL}/images/jmhv-image.webp`,
    },
  };
  ...
  const breadcrumbJsonLd = {
    ...
    itemListElement: [
      ...
      },
      {
        "@type": "ListItem",
        position: 2,
        name: "Business Leadership & Institutions",
        item: PAGE_URL,
      },
    ],
  };
