           ...
           Family Legacy & Historical Roots
            ...
            <div className="mt-8 space-y-6 max-w-xl">
              <p className="text-xs leading-relaxed font-libre-baskerville">
                Julio Herrera Velutini comes from one of Latin America’s longest-standing banking families, with roots tracing back over a century to the early development of Venezuela’s financial system. The Herrera-Velutini name became associated with institution-building, credit formation, and financial stability during a formative period in regional banking history.
              </p>
              
              <p className="text-xs leading-relaxed font-libre-baskerville">
               As a seventh-generation banker, Julio Herrera Velutini represents the modern evolution of this legacy—extending traditional banking principles into global wealth management and international finance. His career reflects a balance between historical stewardship and contemporary financial strategy, ensuring the family’s influence remains relevant in today’s global financial landscape.
              </p>
            </div>
